                ...
                <div class="wrapper-content pd-all-20">
                    ...
                    <div v-if="!isLoading && !verified">
                        ...
                        <div class="form-group mb-3">
                            <label class="text-title-field" for="buyer">Your username on Lienketso</label>
                            <input type="text" class="next-input" v-model="buyer" id="buyer" placeholder="Your Lienketso's username">
                            <div>
                                <small>If your profile page is <a href="https://lienketso.vn/user/thanhan" rel="nofollow">https://lienketso.vn/user/thanhan</a>, then your username on Lienketso is <strong>thanhan</strong>.</small>
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div>
                                ...
                                <div class="float-end text-end">
                                    <small><a href="#" target="_blank">What's this?</a></small>
                                </div>
                        ...
                        <div class="form-group mb-3">
                            <label><input type="checkbox" name="license_rules_agreement" value="1" v-model="licenseRulesAgreement">Confirm that, according to the Lienketso License Terms, each license entitles one person for a single project. Creating multiple unregistered installations is a copyright violation.
                                <a href="#" target="_blank" rel="nofollow">More info</a>.</label>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <p>
                                ...
                                <a href="#" target="_blank" rel="nofollow">new license here</a> to get a new purchase code.</small>
                            </p>
                        </div>
                    </div>
                    <div v-if="!isLoading && verified">
