    ...
    {!! Form::open(['route' => ['settings.edit']]) !!}
        <div class="max-width-1200">
            ...
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>Cấu hình cổ phần</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">Cấu hình các thông tin liên quan cổ phần</p>
                    </div>
                </div>
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="enable_cache">Tên tài khoản thụ hưởng
                            </label>
                            <input type="text" class="next-input" name="stock_bank_name" id="stock_bank_name"
                                   value="{{ setting('stock_bank_name', '') }}">
                        </div>

                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="cache_time">Số tài khoản</label>
                            <input type="text" class="next-input" name="stock_bank_number" id="stock_bank_number"
                                   value="{{ setting('stock_bank_number', '') }}">
                        </div>

                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="enable_cache">Tên ngân hàng
                            </label>
                            <input type="text" class="next-input" name="stock_bank_title" id="stock_bank_title"
                                   value="{{ setting('stock_bank_title', '') }}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>Cấu hình chuyển phát 247</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">Cấu hình các thông tin chuyển phát 247</p>
                    </div>
                </div>
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="enable_cache">ClientID
                            </label>
                            <input type="text" class="next-input" name="247_client_id" id="247_client_id"
                                   value="{{ setting('247_client_id', '') }}">
                        </div>

                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="cache_time">Token</label>
                            <input type="text" class="next-input" name="247_token" id="247_token"
                                   value="{{ setting('247_token', '') }}">
                        </div>
            ...
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    <div class="annotated-section-title pd-all-20">
                        <h2>Cấu hình Zalo ZNS</h2>
                    </div>
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">Cấu hình các thông tin cài đặt để gửi tin nhắn Zalo ZNS</p>
                    </div>
                </div>
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="enable_cache">Bật gửi tin nhắn Zalo ZNS
                            </label>
                            <label class="me-2">
                                <input type="radio" name="enable_zalo_zns" value="1" @if (setting('enable_zalo_zns')) checked @endif>
                                {{ trans('core/setting::setting.general.yes') }}
                            </label>
                            <label>
                                <input type="radio" name="enable_zalo_zns" value="0" @if (!setting('enable_zalo_zns')) checked @endif>
                                {{ trans('core/setting::setting.general.no') }}
                            </label>
                        </div>
                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="enable_cache">Zalo OA ID
                            </label>
                            <input type="text" class="next-input" name="zalo_oa_id" id="zalo_oa_id"
                                   value="{{ setting('zalo_oa_id', '') }}">
                        </div>

                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="cache_time">Zalo Secret key</label>
                            <input type="text" class="next-input" name="zalo_secret_key" id="zalo_secret_key"
                                   value="{{ setting('zalo_secret_key', '') }}">
                        </div>

                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="cache_time">Zalo access token</label>
                            <input type="text" class="next-input" name="zalo_access_token" id="zalo_access_token"
                                   value="{{ setting('zalo_access_token', '') }}">
                        </div>
                        <div class="form-group mb-3">
                            <label class="text-title-field"
                                   for="cache_time">Zalo refresh token ( lấy tại: https://developers.zalo.me/tools/explorer/2059517851848306629 )</label>
                            <input type="text" class="next-input" name="zalo_refresh_token" id="zalo_refresh_token"
                                   value="{{ setting('zalo_refresh_token', '') }}">
                        </div>
