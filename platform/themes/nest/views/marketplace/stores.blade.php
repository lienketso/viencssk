...
<div class="page-content">
    <div class="container">
        <div class="archive-header-2 text-center">
            <h1 class="display-2 mb-20 store-name">{{ SeoHelper::getTitle() }}</h1>
            <div class="row">
                <div class="col-lg-5 mx-auto">
                    <div class="sidebar-widget-2 widget_search mb-50">
                        <div class="search-form">
                            <form action="{{ route('public.stores') }}" method="GET">
                                <input class="form-control" name="q" required value="{{ request()->input('q') }}" type="text" placeholder="Tìm cửa hàng">
            ...
            <div class="col-12 col-lg-8 mx-auto">
                <div class="shop-product-filter">
                    <div class="total-product">
                        <p>{!! clean(__('Đang có :total cửa hàng', ['total' => '<strong class="text-brand">' . $stores->total() . '</strong>'])) !!}</p>
                    </div>
                </div>
            </div>
        </div>
