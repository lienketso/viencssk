...
{{--                <div class="mb-10">--}}
{{--                    <span class="font-small total-product">{{ __(':total sp', ['total' => $store->products_count]) }}</span>--}}
{{--                </div>--}}
            </div>
            ...
            <a href="{{ $store->url }}" class="btn btn-xs">{{ __('Xem cửa hàng') }} <i class="fi-rs-arrow-small-right"></i></a>
        </div>
    </div>
</div>
