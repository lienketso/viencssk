    ...
    <div class="row">
        ...
        @if (count($categories) > 0)
            <div class="col-lg-3 col-md-4 mb-lg-0 mb-md-5 mb-sm-5 widget-filter-item">
                <h5 class="mb-20 widget__title" data-title="{{ __('Category') }}">{{ __('By :name', ['name' => __('danh mục')]) }}</h5>
...
{{--    </div>--}}
    ...
    <div class="widget">
        ...
        <a class="clear_filter dib clear_all_filter mx-4 btn btn-danger btn-sm" href="{{ route('public.products') }}"><i class="fi-rs-refresh mr-5 ml-0"></i> Bỏ lọc</a>
    </div>
</div>
