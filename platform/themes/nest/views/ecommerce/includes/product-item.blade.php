    ...
    <div class="product-cart-wrap mb-20">
        ...
        <div class="product-content-wrap">
            ...
            @if (is_plugin_active('marketplace') && $product->store->id)
                <div>
                    <span class="font-small text-muted"><a href="{{ $product->store->url }}"><i class="fa fa-map-marker"></i> {{ $product->store->name }}</a></span>
                </div>
            @endif
                ...
                @if (EcommerceHelper::isCartEnabled())
                    <div class="add-cart">
                        <a aria-label="{{ __('Add To Cart') }}"
                            ...
                            href="#">
                            <i class="fi-rs-shopping-cart mr-5"></i>Thêm vào giỏ
                        </a>
                    </div>
                @endif
            </div>
