        ...
        @forelse($addresses as $address)
            <div class="col-lg-6 dashboard-address-item @if ($address->is_default) is-address-default @endif">
                <div class="card h-100 mb-3 mb-lg-0 mb-2">
                    ...
                    <div class="card-body">
                        <address>
                            Địa chỉ: {{ $address->address }}<br>Tỉnh/Thành phố: {{ $address->city }},<br>Quận/Huyện: {{ $address->state }}<br>Phường/Thị xã: {{ $address->ward }}
        ...
        @empty
            <div class="col-12">
                <div class="alert alert-dark d-flex align-items-center" role="alert">
                    ...
                    <div>Bạn chưa có địa chỉ nhận hàng nào. <a href="{{route('customer.address.create')}}">Click vào đây</a> để tạo mới</div>
                </div>
            </div>
        @endforelse
