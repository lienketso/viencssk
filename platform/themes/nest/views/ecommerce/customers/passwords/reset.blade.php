                        ...
                        <form class="form--auth form--login" method="POST" action="{{ route('customer.password.reset.post') }}">
                            ...
                            <div class="form__content">
                                <div class="form-group">
                                    <label for="txt-email" class="required">{{ __('Số điện thoại') }}</label>
                                    <input class="form-control" name="phone" id="txt-email" type="text" value="{{ old('phone') }}" placeholder="{{ __('Vui lòng nhập số điện thoại') }}">
                                    @if ($errors->has('phone'))
