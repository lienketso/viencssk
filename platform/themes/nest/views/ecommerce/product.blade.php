...
<div class="product-detail accordion-detail">
                            ...
                            @if (EcommerceHelper::isCartEnabled())
                                ...
                                @if (EcommerceHelper::isQuickBuyButtonEnabled())
                                    <button class="button button-buy-now @if ($product->isOutOfStock()) btn-disabled @endif"
                                        ...
                                        @if ($product->isOutOfStock()) disabled @endif>Mua ngay</button>
                                @endif
                            @endif
                ...
                <div class="font-xs">
                    ...
                    <ul class="mr-50 float-start">
                        ...
                        @if ($product->categories->count())
                            <li class="mb-5">
                                <span class="d-inline-block">Chuyên mục:</span>
                        ...
                        @if ($product->tags->count())
                            <li class="mb-5">
                                <span class="d-inline-block">Thẻ:</span>
    ...
    <div class="product-info">
        <div class="tab-style3">
            <ul class="nav nav-tabs text-uppercase">
                ...
                @if (is_plugin_active('marketplace') && $product->store_id)
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#tab-vendor">Thông tin cửa hàng</a>
                    </li>
                @endif
    ...
    <div class="row mt-60" id="related-products">
        ...
        <related-products-component url="{{ route('public.ajax.related-products', ['id' => $product->id, 'storeid' => $product->store_id]) }}" :limit="{{ $layout == 'product-full-width' ? 4 : 4 }}"></related-products-component>
    </div>
</div>
