<template>
    <div class="container">
        <div class="heading-tab d-flex mb-20">
        ...
        <div class="tab-content wow fadeIn animated">
            ...
            <div class="tab-pane fade show active" v-if="!isLoading" :id="productCategory.slug" role="tabpanel" :aria-labelledby="productCategory.slug + '-tab'" :key="productCategory.id">
                <div class="row product-grid-4">
                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-6 col-sm-6" v-for="item in data" :key="item.id" v-if="data.length" v-html="item">
                    </div>
                </div>
                <!--End product-grid-4-->
            </div>
