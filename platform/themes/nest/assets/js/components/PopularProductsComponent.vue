<template>
    <div class="container" v-if="!noData">
        ...
        <div :class="'row product-grid-' + perRow">
            <div class="col-xxl-2 col-xl-2 col-lg-6 col-md-6 mb-lg-0 mb-md-5 mb-sm-5" v-for="(item, key) in data" :key="key">
                <div class="product-cart-wrap mb-0 wow animate__animated animate__fadeIn" :data-wow-delay="(key + 1) / 10 +'s'">
