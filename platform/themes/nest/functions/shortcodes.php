...
app()->booted(function () {
    ...
    if (is_plugin_active('marketplace')) {
        add_shortcode('home_popup_location', __('Popup hiển thị địa điểm'),
            __('Popup hiển thị địa điểm'),
            function ($shortcode) {
                return Theme::partial('shortcodes.popup-location', compact('shortcode'));
            });
    }
