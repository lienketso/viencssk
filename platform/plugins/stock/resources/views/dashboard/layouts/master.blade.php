...
<head>
    ...
    @yield('header', view('plugins/stock::dashboard.layouts.header'))
...
@yield('body', view('plugins/stock::dashboard.layouts.body'))

@stack('pre-footer')

@if (session()->has('success_msg') || session()->has('success_msg') || session()->has('error_msg') || (isset($errors) && $errors->count() > 0) || isset($error_msg))
    <script type="text/javascript">
		'use strict';
...
@yield('footer', view('plugins/stock::dashboard.layouts.footer'))
