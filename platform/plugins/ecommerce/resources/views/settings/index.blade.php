        ...
        <div class="max-width-1200">
            ...
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    ...
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">Cấu hình các thông tin liên quan đến cơ chế hoàn điểm. Các cấu hình chi có hiệu lực với các giao dịch mới</p>
                    </div>
                </div>
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <label class="next-label">Cấu hình hoàn dài ngày</label>
                        <div class="form-group mb-3 row">
                            <div class="col-sm-6">
                                <label class="text-title-field" for="ubgxu_percent_per_order">Tỷ lệ hoàn / đơn hàng (%)</label>
                                <div class="next-input--stylized">
                                    <input type="text" class="next-input next-input--invisible" name="ubgxu_percent_per_order" id="ubgxu_percent_per_order" value="{{ get_ecommerce_setting('ubgxu_percent_per_order') }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <label class="text-title-field" for="ubgxu_total_day_refund">Số ngày hoàn</label>
                                <input type="text" class="next-input" name="ubgxu_total_day_refund" id="ubgxu_total_day_refund" value="{{ get_ecommerce_setting('ubgxu_total_day_refund') }}">
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <p class="setting-note mb0">Số ngày hoàn ( tương đương số % hoàn mỗi ngày ) VD: hoàn 1% / ngày thì tổng số ngày hoàn là 100 ngày</p>
                        </div>

                        <label class="next-label">Cấu hình hoàn 1 lần</label>
                        <div class="form-group mb-3 row">
                            <div class="col-sm-6">
                                <label class="text-title-field" for="ubgxu_refund_one_percent">Tỷ lệ hoàn / đơn hàng (%)</label>
                                <div class="next-input--stylized">
                                    <input type="text" class="next-input next-input--invisible" name="ubgxu_refund_one_percent" id="ubgxu_refund_one_percent" value="{{ get_ecommerce_setting('ubgxu_refund_one_percent') }}">
                                </div>
                            </div>
                        </div>
                    </div>
...
{{--            Cấu hình hoa hồng--}}
            <div class="flexbox-annotated-section">
                <div class="flexbox-annotated-section-annotation">
                    ...
                    <div class="annotated-section-description pd-all-20 p-none-t">
                        <p class="color-note">Cấu hình các thông tin liên quan đến hoa hồng người tiêu dùng, cộng tác viên, đại lý</p>
                    </div>
                </div>
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group mb-3 row">
                            <div class="col-sm-4">
                                <label class="text-title-field" for="ubgxu_percent_per_order">Người tiêu dùng thứ 1 ( tỷ lệ %)</label>
                                <div class="next-input--stylized">
                                    <input type="number" class="next-input next-input--invisible" name="consumer_level_1"
                                           id="consumer_level_1" value="{{ get_ecommerce_setting('consumer_level_1') }}">
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <label class="text-title-field" for="consumer_level_2">Người tiêu dùng thứ 2 ( tỷ lệ %)</label>
                                <input type="number" class="next-input" name="consumer_level_2" id="consumer_level_2"
                                       value="{{ get_ecommerce_setting('consumer_level_2') }}">
                            </div>
                            <div class="col-sm-4">
                                <label class="text-title-field" for="consumer_level_3">Người tiêu dùng thứ 3 ( tỷ lệ %)</label>
                                <input type="number" class="next-input" name="consumer_level_3" id="consumer_level_3"
                                       value="{{ get_ecommerce_setting('consumer_level_3') }}">
                            </div>
                        </div>

                        <div class="form-group mb-3 row">
                            <div class="col-sm-12">
                                <label class="text-title-field" for="agency_level">Đại lý (%)</label>
                                <div class="next-input--stylized">
                                    <input type="number" class="next-input next-input--invisible" name="agency_level" id="agency_level"
                                           value="{{ get_ecommerce_setting('agency_level') }}">
                                </div>
                            </div>
                        </div>
                    </div>
