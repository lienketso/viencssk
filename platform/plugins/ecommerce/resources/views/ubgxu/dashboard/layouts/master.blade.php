...
@yield('header', view('plugins/ecommerce::ubgxu.dashboard.layouts.header'))
...
@yield('body', view('plugins/ecommerce::ubgxu.dashboard.layouts.body'))
...
{!! Assets::renderFooter() !!}
@yield('footer', view('plugins/ecommerce::ubgxu.dashboard.layouts.footer'))
