        ...
        <div class="flexbox-content">
            <div class="body">
                <div class="box-wrap-emptyTmpl text-center col-12">
                    <h1 class="mt20 mb20 ws-nm font-size-emptyDisplayTmpl">Quản lý danh sách các đơn đăng ký đại lý</h1>
                    <p class="text-info-displayTmpl">Phê duyệt các đơn đăng ký làm đại lý</p>
