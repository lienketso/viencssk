...
@yield('header', view('plugins/ecommerce::collaborator.webview.dashboard.layouts.header'))
...
@yield('body', view('plugins/ecommerce::collaborator.webview.dashboard.layouts.body'))
...
{!! Assets::renderFooter() !!}
@yield('footer', view('plugins/ecommerce::collaborator.webview.dashboard.layouts.footer'))
