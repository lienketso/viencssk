...
return [
    ...
    [
        'name' => 'Đại lý',
        'flag' => 'plugins.collaborator',
    ],
    [
        'name'        => 'Đại lý',
        'flag'        => 'collaborator.index',
        'parent_flag' => 'plugins.collaborator',
    ],
    [
        'name'        => 'Create',
        'flag'        => 'collaborator.create',
        'parent_flag' => 'collaborator.index',
    ],
    [
        'name'        => 'Edit',
        'flag'        => 'collaborator.edit',
        'parent_flag' => 'collaborator.index',
    ],
    [
        'name'        => 'Delete',
        'flag'        => 'collaborator.destroy',
        'parent_flag' => 'collaborator.index',
    ],
    [
        'name'        => 'Yêu cầu đăng ký',
        'flag'        => 'collaborator-request.index',
        'parent_flag' => 'plugins.collaborator',
    ],
    [
        'name'        => 'Create',
        'flag'        => 'collaborator-request.create',
        'parent_flag' => 'collaborator-request.index',
    ],
    [
        'name'        => 'Edit',
        'flag'        => 'collaborator-request.edit',
        'parent_flag' => 'collaborator-request.index',
    ],
    [
        'name'        => 'Delete',
        'flag'        => 'collaborator-request.destroy',
        'parent_flag' => 'collaborator-request.index',
    ],
    [
        'name'        => 'Rút tiền',
        'flag'        => 'withdrawal.index',
        'parent_flag' => 'plugins.collaborator',
    ],
    [
        'name'        => 'Create',
        'flag'        => 'withdrawal.create',
        'parent_flag' => 'withdrawal.index',
    ],
    [
        'name'        => 'Edit',
        'flag'        => 'withdrawal.edit',
        'parent_flag' => 'withdrawal.index',
    ],
    [
        'name'        => 'Delete',
        'flag'        => 'withdrawal.destroy',
        'parent_flag' => 'withdrawal.index',
    ],
