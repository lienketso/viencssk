...
use Botble\Ecommerce\Tables\Front\CollaboratorProductTable;
use EmailHandler;
use Exception;
...
use Throwable;
class CollaboratorProductController extends BaseController
{
    ...
    public function index(CollaboratorProductTable $table)
    {
    ...
    public function store(
        ...
        return $response
            ->setPreviousUrl(route('collaborator.product.index'))
            ->setNextUrl(route('collaborator.product.edit', $product->id))
