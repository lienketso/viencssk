...
class CollaboratorWithdrawal extends BaseModel
{
    use EnumCastable;
     ...
     * @var string
     */
    protected $table = 'ec_collaborator_withdraw';
        ...
        static::updating(function (&$withdrawal) {
            if ($withdrawal->id) {
                ...
                if (in_array($statusOriginal, [WithdrawalStatusEnum::PROCESSING, WithdrawalStatusEnum::PENDING]) &&
                    ...
                    $collaborator = $withdrawal->customer;
                    $collaboratorInfo = $collaborator->walletInfo;
                    $collaboratorInfo->amount += $withdrawal->amount;
