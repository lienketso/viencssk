@extends('plugins/ecommerce::collaborator.dashboard.layouts.master')
@section('content')
                                            ...
                                            <tr>
                                                ...
                                                <td class="pl5 p-r5 text-end">
                                                    <div class="inline_block">
                                                        <span>{{ format_price($orderProduct->price+$orderProduct->tax_amount) }} </span>
                                                    </div>
                                                </td>
                                                ...
                                                @php
                                                    $taxPrice = $orderProduct->price+$orderProduct->tax_amount;
                                                    $taxPrice = round($taxPrice,0,PHP_ROUND_HALF_UP);
                                                @endphp
                                                <td class="pl5 text-end">{{ format_price($taxPrice * $orderProduct->qty) }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <div class="flexbox-grid-default block-rps-768">
                                    ...
                                    <div class="flexbox-auto-right pl5">
                                            ...
                                            <table class="table-normal table-none-border table-color-gray-text">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end pl10">
                                                        <span>{{ format_price(ceil($order->sub_total/100)*100) }}</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="text-end text-no-bold p-none-t pl10">
                                                        @if ($order->payment->id)
                                                            <a href="{{ route('payment.show', $order->payment->id) }}" target="_blank">
                                                                <span>{{ format_price(ceil($order->amount/100)*100) }}</span>
                                                            </a>
                                                        @else
                                                            <span>{{ format_price(ceil($order->amount/100)*100) }}</span>
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end color-subtext pl10">
                                                        @if ($order->payment->id)
                                                            <a href="{{ route('payment.show', $order->payment->id) }}" target="_blank">
                                                                <span>{{ format_price($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED ? ceil($order->payment->amount/100)*100 : 0) }}</span>
                                                            </a>
                                                        @else
                                                            <span>{{ format_price($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED ? ceil($order->payment->amount/100)*100 : 0) }}</span>
                                                        @endif
                                                ...
                                                @if ($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::REFUNDED)
                                                    <tr class="hidden">
                                                        ...
                                                        <td class="text-end pl10">
                                                            <span>{{ format_price(ceil($order->payment->amount/100)*100) }}</span>
                                                        </td>
                                                    </tr>
                                                @endif
                                                <tr class="hidden">
                                                    ...
                                                    <td class="text-end pl10">
                                                        <span>{{ format_price($order->payment->status == \Botble\Payment\Enums\PaymentStatusEnum::COMPLETED ? ceil($order->amount/100)*100 : 0) }}</span>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        @if ($order->isInvoiceAvailable())
                                            <div class="text-end">
                                                <a onclick="printDiv()" class="btn btn-primary me-2" target="_blank">
...
<div id="GFG" style="display: none">
    @include('plugins/ecommerce::invoices.template',$order);
</div>
<script>
    function printDiv() {
