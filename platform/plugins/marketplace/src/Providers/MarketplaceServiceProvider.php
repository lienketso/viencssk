...
use Botble\Marketplace\Repositories\Caches\CommissionCacheDecorator;
...
use Botble\Marketplace\Repositories\Eloquent\CommissionsRepository;
...
class MarketplaceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        if (is_plugin_active('ecommerce')) {
            ...
            $this->app->bind(CommissionsInterface::class,function (){
                return new CommissionCacheDecorator(
                    new CommissionsRepository(new Commissions)
                );
            });
