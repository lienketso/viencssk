...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=script&lang=js&":
/*!****************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=script&lang=js& ***!
  \****************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      child_is_checked: this.isChecked,
      child_point_amount: this.point_amount
    };
  },
  ...
  methods: {
    ...
    createOrder: function createOrder($event) {
      ...
      axios.post(route('orders.create'), {
        ...
        ubgxu_checked: this.child_is_checked,
        ubgxu_checkout: this.child_point_amount
      }).then(function (res) {
        ...
        if (res.data.error) {
          ...
          setTimeout(function () {
            window.location.href = route('marketplace.vendor.orders.edit', data.id);
          }, 1000);
        }
      })["catch"](function (res) {
        Botble.handleError(res.response.data);
    ...
    updateOrderAddress: function updateOrderAddress($event) {
      ...
      if (this.customer) {
        ...
        this.child_customer_address.presenter_id = $modal.find('.customer-address-presenter-id').val();
        var context = this;
        setTimeout(function () {
          $($event.target).find('.btn-primary').removeClass('button-loading');
    ...
    createNewCustomer: function createNewCustomer($event) {
      ...
      axios.post(route('customers.create-customer-when-creating-order'), {
        ...
        presenter_id: context.child_customer_address.presenter_id
      }).then(function (res) {
        if (res.data.error) {
          Botble.showError(res.data.message);
          $($event.target).find('.btn-primary').removeClass('button-loading');
    ...
    calculateAmount: function calculateAmount(products) {
      ...
      context.child_total_amount = parseFloat(context.child_sub_amount) - (parseFloat(context.child_discount_amount) + parseFloat(context.child_point_amount)) + parseFloat(context.child_shipping_amount);
    ...
    handleUbgXu: function handleUbgXu(value) {
      var context = this;
      if (this.isChecked) {
        if (context.child_customer.ubgxu >= context.child_sub_amount) {
          context.child_point_amount = context.child_sub_amount;
        } else {
          context.child_point_amount = value;
        }
        context.child_is_checked = 'on';
      } else {
        context.child_point_amount = 0;
        context.child_is_checked = 'off';
      }
    },
  ...
  watch: {
    ...
    'child_discount_amount': function child_discount_amount(value) {
      var context = this;
      context.child_total_amount = parseFloat(context.child_sub_amount) - (parseFloat(value) + parseFloat(context.child_point_amount)) + parseFloat(context.child_shipping_amount);
    },
    'child_shipping_amount': function child_shipping_amount(value) {
      var context = this;
      context.child_total_amount = parseFloat(context.child_sub_amount) - (parseFloat(context.child_discount_amount) + parseFloat(context.child_point_amount)) + parseFloat(value);
    },
    'child_point_amount': function child_point_amount(value) {
      var context = this;
      context.child_total_amount = parseFloat(context.child_sub_amount) - (parseFloat(context.child_discount_amount) + parseFloat(value)) + parseFloat(context.child_shipping_amount);
    },
...
/***/ "./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue":
/*!***********************************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _CollaboratorCreateOrder_vue_vue_type_template_id_dff230da___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CollaboratorCreateOrder.vue?vue&type=template&id=dff230da& */ "./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=template&id=dff230da&");
/* harmony import */ var _CollaboratorCreateOrder_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CollaboratorCreateOrder.vue?vue&type=script&lang=js& */ "./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _CollaboratorCreateOrder_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _CollaboratorCreateOrder_vue_vue_type_template_id_dff230da___WEBPACK_IMPORTED_MODULE_0__.render,
  _CollaboratorCreateOrder_vue_vue_type_template_id_dff230da___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CollaboratorCreateOrder_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CollaboratorCreateOrder.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_CollaboratorCreateOrder_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=template&id=dff230da&":
/*!******************************************************************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=template&id=dff230da& ***!
  \******************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CollaboratorCreateOrder_vue_vue_type_template_id_dff230da___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CollaboratorCreateOrder_vue_vue_type_template_id_dff230da___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CollaboratorCreateOrder_vue_vue_type_template_id_dff230da___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./CollaboratorCreateOrder.vue?vue&type=template&id=dff230da& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=template&id=dff230da&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=template&id=dff230da&":
/*!*********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue?vue&type=template&id=dff230da& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(
                                      parseFloat(
                                        Math.round(variant.price / 100) * 100
                                      ).toLocaleString()
                                    ) +
                                      "\n                  " +
                                      _vm._s(_vm.currency) +
              ...
              _c("div", { staticClass: "box-search-advance product" }, [
                _c("div", [
                  _c("input", {
                    ...
                    attrs: {
                      type: "text",
                      placeholder: _vm.__("Tìm kiếm hoặc thêm sản phẩm mới"),
                    },
                    on: {
                      click: function ($event) {
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("span", { staticClass: "ml10" }, [
                            _vm._v(_vm._s(_vm.__("Thêm sản phẩm mới"))),
                          ]),
                        ]
                      ),
                      _vm._v(" "),
                ...
                _c("div", { staticClass: "form-group mb-3" }, [
                  ...
                  _c("textarea", {
                    ...
                    attrs: {
                      id: "txt-note",
                      rows: "2",
                      placeholder: _vm.__("Ghi chú cho đơn hàng"),
                    },
                      ...
                      _c("tbody", [
                        _c("tr", [
                          _c("td", { staticClass: "color-subtext" }, [
                            _vm._v(_vm._s(_vm.__("Tổng cộng"))),
                          ]),
                          _vm._v(" "),
                          _c("td", { staticClass: "pl10" }, [
                            _vm._v(
                              _vm._s(
                                parseFloat(
                                  Math.round(_vm.child_sub_amount / 100) * 100
                                ).toLocaleString()
                              ) +
                                " " +
                                _vm._s(_vm.currency)
                              ...
                              [
                                !_vm.child_is_selected_shipping
                                  ? _c("span", [
                                      ...
                                      _vm._v(
                                        " " +
                                          _vm._s(_vm.__("Thêm phí vận chuyển"))
                                      ),
                                    ])
                                  : _vm._e(),
                                _vm._v(" "),
                                _vm.child_is_selected_shipping
                                  ? _c("span", [
                                      _vm._v(_vm._s(_vm.__("Phí vận chuyển"))),
                                    ])
                                  : _vm._e(),
                              ]
                            ),
                        ...
                        _vm._v(" "),
                        _c("tr", {}, [
                          _c("td", [_vm._v("Thanh toán bằng điểm")]),
                          _vm._v(" "),
                          _c("td", {}, [
                            _vm._v(
                              _vm._s(
                                parseFloat(
                                  Math.round(_vm.child_point_amount / 100) * 100
                                ).toLocaleString()
                              ) + " điểm"
                            ),
                          ]),
                        ...
                        _c("tr", { staticClass: "text-no-bold" }, [
                          _c("td", [_vm._v(_vm._s(_vm.__("Tổng thanh toán")))]),
                          _vm._v(" "),
                          _c("td", { staticClass: "pl10" }, [
                            _vm._v(
                              _vm._s(
                                parseFloat(
                                  Math.round(_vm.child_total_amount / 100) * 100
                                ).toLocaleString()
                              ) +
                                " " +
                                _vm._s(_vm.currency)
              ...
              _c("div", { staticClass: "col-sm-12" }, [
                _vm.child_customer_id && _vm.child_customer
                  ? _c("div", { staticClass: "form-group mb-3" }, [
                      _c("input", {
                        ...
                        on: {
                          change: [
                            ...
                            function ($event) {
                              return _vm.handleUbgXu(_vm.child_customer.ubgxu)
                            },
                          ],
                        },
                      }),
                      ...
                      _vm._v(" "),
                      _c("p", [
                        _vm._v("Số điểm khả dụng : "),
                        _c("strong", [
                          _vm._v(_vm._s(_vm.child_customer.ubgxu)),
                        ]),
                        _vm._v(" điểm"),
                      ]),
                    ])
                ...
                _c("div", { staticClass: "flexbox-grid-default mt5 mb5" }, [
                  ...
                  _c("div", { staticClass: "flexbox-auto-content" }, [
                    _c("div", { staticClass: "text-upper ws-nm" }, [
                      _vm._v(
                        _vm._s(_vm.__("XÁC NHẬN THANH TOÁN VÀ TẠO ĐƠN HÀNG"))
                      ),
                    ]),
                  ]),
                ]),
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    [_vm._v(_vm._s(_vm.__("Trả tiền sau")) + "\n            ")]
                  ),
                ]
              ),
            ]),
                  ...
                  _c("div", { staticClass: "flexbox-grid-default mb15" }, [
                    _c("div", { staticClass: "flexbox-auto-content" }, [
                      _c("label", { staticClass: "title-product-main" }, [
                        _vm._v(_vm._s(_vm.__("Thông tin khách hàng"))),
                      ]),
                    ]),
                  ]),
                  _vm._v(" "),
                      ...
                      _c("div", [
                        _c("input", {
                          ...
                          attrs: {
                            type: "text",
                            placeholder: _vm.__(
                              "Tìm kiếm theo số điện thoại hoặc thêm mới"
                            ),
                          },
                          on: {
                            click: function ($event) {
                ...
                _c("div", { staticClass: "next-card-section p-none-b" }, [
                  _c("div", { staticClass: "flexbox-grid-default" }, [
                    _c("div", { staticClass: "flexbox-auto-content-left" }, [
                      _c("label", { staticClass: "title-product-main" }, [
                        _vm._v(_vm._s(_vm.__("Khách hàng"))),
                      ]),
                    ]),
                    _vm._v(" "),
                    ...
                    _c("li", [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("span", [
                            _vm._v(_vm._s(_vm.child_customer_order_numbers)),
                          ]),
                          _vm._v(
                            "\n                " +
                              _vm._s(_vm.__("Đơn hàng")) +
                              "\n              "
                          ),
                        ]
                      ),
                        ...
                        _c(
                          ...
                          [
                            _c("label", { staticClass: "title-text-second" }, [
                              _vm._v(_vm._s(_vm.__("Địa chỉ nhận hàng"))),
                            ]),
                          ]
                        ),
                        _vm._v(" "),
                    ...
                    _c("li", { staticClass: "text-infor-subdued mt15" }, [
                      ...
                      _c("div", [
                        _c(
                          ...
                          [_vm._v(_vm._s(_vm.__("Tìm trên bản đồ")))]
                        ),
                      ]),
                    ]),
                  ]),
        ...
        [
          _c("div", { staticClass: "form-group mb15" }, [
            _c("label", { staticClass: "text-title-field" }, [
              _vm._v(_vm._s(_vm.__("Tên sản phẩm"))),
            ]),
            _vm._v(" "),
            _c("input", {
              directives: [
          ...
          _c("div", { staticClass: "form-group mb15 row" }, [
            _c("div", { staticClass: "col-6" }, [
              _c("label", { staticClass: "text-title-field" }, [
                _vm._v(_vm._s(_vm.__("Giá sản phẩm"))),
              ]),
              _vm._v(" "),
              _c("input", {
                directives: [
            ...
            _c("div", { staticClass: "col-6" }, [
              _c("label", { staticClass: "text-title-field" }, [
                _vm._v(_vm._s(_vm.__("Mã sản phẩm (SKU)"))),
              ]),
              _vm._v(" "),
              _c("input", {
                directives: [
                  ...
                  _c("label", { staticClass: "next-label" }, [
                    ...
                    _vm._v(
                      "\n            " +
                        _vm._s(
                          _vm.__(
                            "Cho phép khách hàng thanh toán khi sản phẩm này hết hàng?"
                          )
                        )
                    ),
                  ]),
      ...
      _c(
        "b-modal",
        {
          attrs: {
            id: "add-customer",
            title: _vm.__("Thêm mới khách hàng"),
            "ok-title": _vm.__("Lưu lại"),
            "cancel-title": _vm.__("Bỏ qua"),
          },
          on: {
            shown: function ($event) {
        ...
        [
          _c("div", { staticClass: "next-form-section" }, [
            _c("div", { staticClass: "next-form-grid" }, [
              ...
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "text-title-field" }, [
                  _vm._v(_vm._s(_vm.__("Số điện thoại"))),
                ]),
                _vm._v(" "),
                _c("input", {
                  directives: [
            ...
            _c("div", { staticClass: "next-form-grid" }, [
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "text-title-field" }, [
                  _vm._v(_vm._s(_vm.__("Quận Huyện"))),
                ]),
                _vm._v(" "),
              ...
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "text-title-field" }, [
                  _vm._v(_vm._s(_vm.__("Thành phố"))),
                ]),
                _vm._v(" "),
                _vm.use_location_data
                  ? _c("div", { staticClass: "ui-select-wrapper" }, [
            ...
            _vm.zip_code_enabled
              ? _c("div", { staticClass: "next-form-grid" }, [
                  _c("div", { staticClass: "next-form-grid-cell" }, [
                    _c("label", { staticClass: "text-title-field" }, [
                      _vm._v(_vm._s(_vm.__("Mã quốc gia"))),
                    ]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.child_customer_address.presenter_id,
                      expression: "child_customer_address.presenter_id",
                    },
                  ],
                  staticClass: "next-input customer-address-presenter-id",
                  attrs: { type: "text" },
                  domProps: { value: _vm.child_customer_address.presenter_id },
                  on: {
                    input: function ($event) {
                      if ($event.target.composing) {
                        return
      ...
      _c(
        "b-modal",
        {
          attrs: {
            id: "add-discounts",
            title: "Add discount",
            "ok-title": _vm.__("Thêm giảm giá"),
            "cancel-title": _vm.__("Đóng"),
          },
          on: {
            ok: function ($event) {
        ...
        [
          _c("div", { staticClass: "next-form-section" }, [
            _c("div", { staticClass: "next-form-grid" }, [
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "text-title-field" }, [
                  _vm._v(_vm._s(_vm.__("Giảm giá dựa trên"))),
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "flexbox-grid-default" }, [
                  _c("div", { staticClass: "flexbox-auto-left" }, [
            ...
            _c("div", { staticClass: "next-form-grid" }, [
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "text-title-field" }, [
                  _vm._v(_vm._s(_vm.__("Hoặc mã giảm giá"))),
                ]),
                _vm._v(" "),
                _c(
                  "div",
            ...
            _c("div", { staticClass: "next-form-grid" }, [
              _c("div", { staticClass: "next-form-grid-cell" }, [
                ...
                _c("input", {
                  ...
                  staticClass: "next-input",
                  attrs: { placeholder: _vm.__("Mô tả về phiếu giảm giá") },
      ...
      _c(
        "b-modal",
        {
          attrs: {
            id: "add-shipping",
            title: _vm.__("Phí vận chuyển"),
            "ok-title": _vm.__("Cập nhật"),
            "cancel-title": _vm.__("Đóng"),
          },
          on: {
            shown: function ($event) {
                      ...
                      [
                        ...
                        _c("div", { staticClass: "ui-banner__content" }, [
                          _c("h2", { staticClass: "ui-banner__title" }, [
                            _vm._v(
                              _vm._s(
                                _vm.__("Cách lựa chọn cấu hình vận chuyển?")
                              )
                            ),
                          ]),
                          _vm._v(" "),
                          _c("div", { staticClass: "ws-nm" }, [
                            _vm._v(
                              _vm._s(
                                _vm.__(
                                  "Vui lòng thêm thông tin khách hàng cùng địa chỉ giao hàng đầy đủ để xem mức phí vận chuyển được định cấu hình."
                                )
                              ) + ".\n            "
                            ),
                          ]),
            ...
            _c("div", { staticClass: "next-form-grid" }, [
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "next-label" }, [
                  ...
                  _vm._v(
                    "\n            " + _vm._s(_vm.__("Miễn phí vận chuyển"))
                  ),
                ]),
              ]),
            ]),
      ...
      _c(
        "b-modal",
        {
          attrs: {
            id: "edit-address",
            title: _vm.__("Cập nhật địa chỉ"),
            "ok-title": _vm.__("Lưu lại"),
            "cancel-title": _vm.__("Hủy"),
          },
          on: {
            shown: function ($event) {
              return _vm.loadCountries()
        ...
        [
          _c("div", { staticClass: "next-form-section" }, [
            _c("div", { staticClass: "next-form-grid" }, [
              _c("div", { staticClass: "next-form-grid-cell" }, [
                _c("label", { staticClass: "text-title-field" }, [
                  _vm._v(_vm._s(_vm.__("Họ và tên"))),
                ]),
                _vm._v(" "),
                _c("input", {
                  directives: [
      ...
      _c(
        "b-modal",
        {
          attrs: {
            id: "make-paid",
            title: _vm.__(
              "Xác nhận thanh toán được thanh toán cho đơn hàng này"
            ),
            "ok-title": _vm.__("Xác nhận ngay"),
            "cancel-title": _vm.__("Hủy"),
          },
          on: {
            ok: function ($event) {
        ...
        [
          _c("div", { staticClass: "note note-warning" }, [
            _vm._v(
              "\n      " +
                _vm._s(
                  _vm.__(
                    "Trạng thái thanh toán của đơn hàng là Đã thanh toán. Khi đơn hàng đã được tạo, bạn không thể thay đổi phương thức hoặc trạng thái thanh toán."
                  )
                ) +
                ".\n    "
            ),
          ...
          _vm._v(" "),
          _c("p", [_vm._v(_vm._s(_vm.__("Chọn phương thức thanh toán")))]),
          _vm._v(" "),
          _c(
            "div",
              ...
              _c(
                ...
                [
                  _c("option", { attrs: { value: "cod" } }, [
                    _vm._v(_vm._s(_vm.__("Thanh toán khi giao hàng"))),
                  ]),
                  _vm._v(" "),
                  _c("option", { attrs: { value: "bank_transfer" } }, [
                    _vm._v(_vm._s(_vm.__("Chuyển khoản"))),
                  ]),
                ]
              ),
              _vm._v(" "),
          ...
          _vm._v(" "),
          _c("p", [
            _vm._v(_vm._s(_vm.__("Số tiền thanh toán")) + " : "),
            _c("span", [
              _vm._v(
                _vm._s(
                  parseFloat(
      ...
      _c(
        "b-modal",
        {
          attrs: {
            id: "make-pending",
            title: _vm.__(
              "Xác nhận rằng khoản thanh toán cho đơn hàng này sẽ được thanh toán sau"
            ),
            "ok-title": _vm.__("Xác nhận"),
            "cancel-title": _vm.__("Hủy"),
          },
          on: {
            ok: function ($event) {
        ...
        [
          _c("div", { staticClass: "note note-warning" }, [
            _vm._v(
              "\n      " +
                _vm._s(
                  _vm.__(
                    "Trạng thái thanh toán của đơn hàng là Đang chờ xử lý. Khi đơn hàng đã được tạo, bạn không thể thay đổi phương thức hoặc trạng thái thanh toán."
                  )
                ) +
                ".\n    "
            ),
          ...
          _vm._v(" "),
          _c("p", [
            _vm._v(_vm._s(_vm.__("Số tiền đang chờ xử lý")) + " : "),
            _c("span", [
              _vm._v(
                _vm._s(
                  parseFloat(
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "pd-all-20" }, [
  ...
  function () {
    ...
    return _c(
      "label",
      { staticClass: "form-check-label", attrs: { for: "remember-checkbox" } },
      [_c("span", [_vm._v("Thanh toán trước bằng điểm")])]
    )
  },
  function () {
    var _vm = this
...
"use strict";
/*!*************************************************************************************!*\
  !*** ./platform/plugins/ecommerce/resources/assets/js/collaborator-order-create.js ***!
  \*************************************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_CollaboratorCreateOrder_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/CollaboratorCreateOrder.vue */ "./platform/plugins/ecommerce/resources/assets/js/components/CollaboratorCreateOrder.vue");
...
vue__WEBPACK_IMPORTED_MODULE_1__["default"].component('create-order', _components_CollaboratorCreateOrder_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
